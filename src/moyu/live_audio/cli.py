...
from moyu.config import Settings, SupportedPlatform
...
async def run(settings: Settings):
    ...
    register_room_classes_map: dict[SupportedPlatform, Type[LiveAudioRoom]] = dict()
    ...
    try:
        ...
        for idx, info in enumerate(infos):
            ...
            if isinstance(info, Exception):
                ...
                owner, title, status = info  # ty:ignore[not-iterable]
        ...
        await asyncio.gather(*(room.close() for room in rooms))
